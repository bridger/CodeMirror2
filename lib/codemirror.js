...
var CodeMirror = (function() {
  ...
  Line.prototype = {
    ...
    highlight: function(mode, state, tabSize) {
      ...
      if (st.length == 2 && st[1] && typeof st[1] == 'function') {this.isWidgetBlock = true; this.growHeight(304.0 / 13.0 - this.height);}
      else if (this.isWidgetBlock) {this.isWidgetBlock = false; this.growHeight(1 - this.height);}
    ...
    getHTML: function(makeTab, endAt) {
      ...
      if (this.isWidgetBlock) return st[1](allText);
